...
public class ClassContext {
    ...
    public static class ContextBuilder {
        ...
        public FieldNode allocateOrGetFieldNode(String className, String name, String signature, boolean isStatic) {
            ...
            referenceFieldBuilder.append("methods[%s] = (jmethodID)std::stoll(request(std::format(\"http://localhost:6555/decrypt?value={}&seed=%s&rtdsc={}\", ((__int64)env->Get%sMethodID(env->FindClass(\"%s\"), \"%s\", \"%s\") ^ %s), rtdsc)));\n"
